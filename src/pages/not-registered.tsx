			...
			<Card className="py-6 px-8 w-96 shadow-lg bg-white dark:bg-gray-800 dark:text-white transition-colors duration-300">
				<CardBody className="flex flex-col items-center text-center">
					...
					<p className="text-gray-700 dark:text-gray-300 mb-6">
						Akun Anda belum terdaftar dalam sistem kami. Silakan hubungi admin untuk mendapatkan
						akses.
					</p>

					<Button className="w-full bg-blue-600 text-white mt-4" onPress={handleBackToLogin}>
						Kembali ke Login
					</Button>
				</CardBody>
			</Card>
